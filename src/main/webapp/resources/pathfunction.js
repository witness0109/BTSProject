function makePathBox(start, end, obj, midString, classtype) {
    ...
    + '" onclick ="callMapOutCity(\'' + stp.info.mapObj + '\',\'' + obj.SX + '\',\'' + obj.SY + '\',\'' + obj.EX + '\',\'' + obj.EY + '\',\'' + endp.info.mapObj + '\')">'
    +'<div class="pathborder"  onclick="callMapObjApiAJAX(\'' + stp.info.mapObj + '\');"><h6>출발지로 가는길</h6>';
    ...
    result += "</div></div>"
    result += midString
    result += '<div class="pathborder"  onclick="callMapObjApiAJAX(\'' + endp.info.mapObj + '\');"><h6>도착지로 가는길</h6>' + opendivdom + '<div class="subpath1">';
