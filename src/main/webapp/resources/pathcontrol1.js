...
function findPathCityIn(result) {
    ...
    let option = '전체<input type="radio" name="opt" checked value="0">버스<input type="radio" name="opt" value="1">지하철<input type="radio" name="opt" value="2">버스+지하철<input type="radio" name="opt" value="3">'
    $('#searchOption').html(option)
    $('#searchOption').addClass('box')
    $('#findbox').html(str)
    $('#findresult').html(bustrain + busonly + subwayonly)
